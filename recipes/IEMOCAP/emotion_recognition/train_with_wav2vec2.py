...
> python train_with_wav2vec2.py hparams/train_with_wav2vec2.yaml --data_folder /Users/safaldhungana/Documents/University/Masterproef/Audio_data/IEMOCAP_full_release
> python train_with_wav2vec2.py hparams/train_with_wav2vec2.yaml --data_folder /Users/safaldhungana/Documents/University/Masterproef/Audio_data/IEMOCAP_full_release
...
class EmoIdBrain(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        # outputs = self.hparams.log_softmax(outputs) no softmax needed for regression
        return outputs
    ...
    def on_stage_start(self, stage, epoch=None):
        ...
        self.loss_metric = sb.utils.metric_stats.MetricStats(
            metric=sb.nnet.losses.nll_loss     # is used for classification
            metric=self.hparams.error_stats()["metric"]
        )
        """
    ...
    def on_stage_end(self, stage, stage_loss, epoch=None):
        ...
        # Summarize the statistics from the stage for record-keeping.
            ...
            stats = {
                "loss": stage_loss
                # "error_rate": self.error_metrics.summarize("average"), no need for error rate in regression
            }
...
@sb.utils.data_pipeline.takes("valance", "arousal")
@sb.utils.data_pipeline.provides("valance", "arousal")
